...
public sealed class PlanCatalogService
{
    ...
    private static readonly IReadOnlyDictionary<string, PlanDefinition> Plans =
        new[]
        {
            new PlanDefinition("silver_1m", SubscriptionTiers.Silver, 1, 48_000, 5, 30, 48_000),
            new PlanDefinition("silver_6m", SubscriptionTiers.Silver, 6, 259_000, 5, 30, 48_000),
            new PlanDefinition("silver_12m", SubscriptionTiers.Silver, 12, 489_000, 5, 30, 48_000),
            new PlanDefinition("gold_1m", SubscriptionTiers.Gold, 1, 88_000, 10, 100, 88_000),
            new PlanDefinition("gold_6m", SubscriptionTiers.Gold, 6, 475_000, 10, 100, 88_000),
            new PlanDefinition("gold_12m", SubscriptionTiers.Gold, 12, 899_000, 10, 100, 88_000)
        }.ToDictionary(x => x.Sku, StringComparer.OrdinalIgnoreCase);

    public static EntitlementSnapshot Free => new(SubscriptionTiers.Free, 2, 3, Version);
